            ...
            <div class="d-flex justify-content-between align-items-center">
              ...
              <div class="btn-apply">
                <button @click="onDetail(item)" class="btn btn-info btn-orange">
                  <i class="fa fa-plus-square-o" ></i>  สมัครงาน
                </button>
              </div>
            </div>
...
<br>
   ...
   <div class="pagination-container">
    ...
    <ApplyDialog :jobs="jobItem" @onClose="jobItem = null" />
    <ApplyDetailDialog :jobs="jobDetailItem" @onClose="jobDetailItem = null" @onApply="jobItem = $event" />
