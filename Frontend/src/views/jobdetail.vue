...
export default {
  ...
  watch: {
    jobs(value) {
      ...
      Axios.get(`/api/showapply/job/${value.j_id}`)
        .then(response => {
  ...
  methods: {
    onApply() {
  // นำคุณไปยังหน้า 'login' โดยใช้ this.$router.push
