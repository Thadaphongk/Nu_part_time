  ...
  <nav class="navbar navbar-expand-sm">
    <div class="container-fluid">
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item" v-if="sessionData && sessionData.u_firstname">
          <a class="nav-link-style" href="#">
            <i class="fa fa-user" aria-hidden="true"></i> <!-- Font Awesome user icon -->
            ชื่อผู้ใช้ : {{ sessionData.u_firstname }}
          </a>
        </li>
        <li class="nav-divider"></li>
        <li class="nav-item"  style="margin-right: 5px;">
          <a class="nav-link-style" href="/Apply/history">
            <i class="fa fa-search"></i> ตรวจสอบงาน</a>
        </li>
        <li class="nav-divider"></li>
        <li class="nav-item" style="margin-right: 5px;">
    <a class="nav-link-style" href="/Apply/ApplyEdit">
...
.nav-link-style:hover {
  color: #ff6d43; /* Change text color on hover */
}
...
.nav-divider {
  ...
  border-left: 2px solid #ccc; /* Color and thickness of the separator */
