...
const tables = 'SELECT * FROM job_db.tb_apply JOIN tb_detailjob ON job_db.tb_apply.tb_detailjob_j_id = tb_detailjob.j_id JOIN tb_owner ON tb_detailjob.tb_owner_o_id = tb_owner.o_id;';
module.exports = {
